...
# Visit data 
visit_drepano = pd.read_csv("./data/CVO_stay.csv")
...
# Transfusion
transfusion = pd.read_csv("./data/CVO_transfusion.csv",
                          sep=';',
                          encoding="ISO-8859-1")
...
# Bio data including bios urgence
bio_drepano = pd.read_csv("./data/CVO_bio_dont_sau.csv",
                          sep=';', encoding="utf-8")
...
# Demographic data
demography = pd.read_csv("./data/CVO_patients.csv")
...
vital_parameters = pd.read_csv("./data/CVO_param.csv",
                               sep=';',
                               encoding="ISO-8859-1")
...
# Pancarte data
pancarte = pd.read_csv("./data/CVO_pancarte.csv",
                       sep=';',
                       encoding="ISO-8859-1")
print("Pancarte data:")
...
# Syringes data
Syringes = pd.read_csv("./data/CVO_seringues.csv",
                       sep=',',
                       encoding="ISO-8859-1")
print("\nSyringes data:")
...
all_visits = pd.io.parsers.read_table("./data/CVO_previous.csv",
                                      sep=',')
...
consult = pd.read_csv("./data/consult.csv", sep=";")
